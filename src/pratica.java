...
Você foi contratado para desenvolver uma parte de um sistema simples que realiza duas tarefas:
...
1. Crie um metodo void chamado exibirMensagem que:
- Receba o nome do usuário como parâmetro (tipo String);
- Imprima uma saudação como: "Olá, [nome]! Seja bem-vindo ao sistema!"
